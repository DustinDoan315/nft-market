...
contract NftMarketplace {
    ...
    /**
     * @dev Returns the list of token IDs owned by a specific user.
     * @param user The address of the user to retrieve NFTs for.
     */
    function getListByUser(address user) external view returns (uint256[] memory) {
